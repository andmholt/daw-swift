...
//                AudioTrackViewModel(setHoveringTrack: setHoveringTrack, setHoveringClip: setHoveringClip, deleteTrack: deleteTrack, getMergeBufId: getMergeBufId, mergeBuf: mergeBuf, audioFiles: ["_ phone"]),
        ...
        func addTrack() {
            ...
            self.tracks.append(AudioTrackViewModel(setHoveringTrack: setHoveringTrack, setHoveringClip: setHoveringClip, deleteTrack: deleteTrack, getMergeBufId: getMergeBufId, mergeBuf: mergeBuf, audioFiles: [""], tabColor: .cyan, title: "New Track"))
        }
